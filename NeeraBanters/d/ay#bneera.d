...
CHAIN IF WEIGHT #-1 ~Global("AY#NEBR1","LOCALS",0) InParty("branwen") See("branwen") !StateCheck("branwen",CD_STATE_NOTVALID) !StateCheck(Myself,CD_STATE_NOTVALID) CombatCounter(0) !See([ENEMY])~ THEN BNEERA NeBr1Chain
...
CHAIN IF WEIGHT #-1 ~Global("AY#NEBR2","LOCALS",0) InParty("branwen") See("branwen") !StateCheck("branwen",CD_STATE_NOTVALID) !StateCheck(Myself,CD_STATE_NOTVALID) CombatCounter(0) !See([ENEMY])~ THEN BNEERA NeBr2Chain 
...
CHAIN IF WEIGHT #-1 ~Global("AY#NECO1","LOCALS",0) InParty("neera") See("neera") !StateCheck("neera",CD_STATE_NOTVALID) !StateCheck(Myself,CD_STATE_NOTVALID) CombatCounter(0) !See([ENEMY])~ THEN BCORAN NeCo1Chain ~Neera, your eyes sparkle like the peaks of the Starspire Mountains.~ DO ~SetGlobal("AY#NECO1","LOCALS",1)~
...
CHAIN IF WEIGHT #-1 ~Global("AY#NEDY1","LOCALS",0) InParty("neera") See("neera") !StateCheck("neera",CD_STATE_NOTVALID) !StateCheck(Myself,CD_STATE_NOTVALID) CombatCounter(0) !See([ENEMY])~ THEN BDYNAH NeDy1Chain ~Neera, I would talk with thou about thy wild magic.~ DO ~SetGlobal("AY#NEDY1","LOCALS",1) SetGlobalTimer("AY#NeDy2Timer","GLOBAL",THREE_DAYS)~
...
CHAIN IF WEIGHT #-1 ~Global("AY#NEDY1","LOCALS",1) GlobalTimerExpired("AY#NeDy2Timer","GLOBAL") InParty("neera") See("neera") !StateCheck("neera",CD_STATE_NOTVALID) !StateCheck(Myself,CD_STATE_NOTVALID) CombatCounter(0) !See([ENEMY])~ THEN BDYNAH NeDy2Chain ~Neera, thou mentioned 'Frixis' previously. Was he thy instructor in the arcane arts?~ DO ~SetGlobal("AY#NEDY1","LOCALS",2)~
...
== BDYNAH ~An interesting perspective, child - but a dangerous one. Thou art wielding forces thou dost scarcely comprehend.~
EXIT

CHAIN IF WEIGHT #-1 ~Global("AY#NEDY3","LOCALS",0) InParty("dynaheir") See("dynaheir") !StateCheck("dynaheir",CD_STATE_NOTVALID) !StateCheck(Myself,CD_STATE_NOTVALID)  CombatCounter(0) !See([ENEMY])~ THEN BNEERA NeDy3Chain ~Dynaheir, what do you know about the Red Wizards?~ DO ~SetGlobal("AY#NEDY3","LOCALS",1)~
...
CHAIN IF WEIGHT #-1 ~Global("AY#NEFA1","LOCALS",0) InParty("neera") See("neera") !StateCheck(Myself,CD_STATE_NOTVALID) !StateCheck("neera",CD_STATE_NOTVALID) CombatCounter(0)  !See([ENEMY]) AreaType(OUTDOOR) !AreaType(CITY) TimeOfDay(DAY)~ THEN BFALDO NeFa1Chain ~Aaaaahhh!  Do you smell that?  That is the smell of nature.  Much better than the foul, disgusting stench of cities.~ DO ~SetGlobal("AY#NEFA1","LOCALS",1)~
== BNEERA ~Those droppings we stumbled upon earlier were pretty disgusting too. Phew!~
...
CHAIN IF WEIGHT #-1 ~Global("AY#NEIM1","LOCALS",0) InParty("neera") See("neera") !StateCheck(Myself,CD_STATE_NOTVALID) !StateCheck("neera",CD_STATE_NOTVALID) !See([ENEMY]) CombatCounter(0) ~ THEN BIMOEN NeIm1Chain ~Heya! Can I ask ya a question, Neera?~ DO ~SetGlobal("AY#NEIM1","LOCALS",1)~
...
CHAIN IF WEIGHT #-1 ~Global("AY#NeImStars","GLOBAL",3) InParty("imoen") See("imoen") !StateCheck(Myself,CD_STATE_NOTVALID) !StateCheck("imoen",CD_STATE_NOTVALID) CombatCounter(0) !See([ENEMY]) TimeOfDay(NIGHT) AreaType(OUTDOOR) !AreaType(CITY)~ THEN NEERAJ NeIm2Chain ~*sigh*~ DO ~SetGlobal("AY#NeImStars","GLOBAL",4)~
...
CHAIN IF WEIGHT #-1 ~Global("AY#NEJA1","LOCALS",0) InParty("jaheira") See("jaheira") !StateCheck(Myself,CD_STATE_NOTVALID) !StateCheck("jaheira",CD_STATE_NOTVALID) CombatCounter(0) !See([ENEMY]) AreaType(OUTDOOR) !AreaType(CITY)~ THEN BNEERA NeJa1Chain ~Go away! Shoo! Ack!~ DO ~SetGlobal("AY#NEJA1","LOCALS",1)~
...
CHAIN IF WEIGHT #-1 ~Global("AY#NEJA2","LOCALS",0) InParty("jaheira") See("jaheira") !StateCheck(Myself,CD_STATE_NOTVALID) !StateCheck("jaheira",CD_STATE_NOTVALID) CombatCounter(0) !See([ENEMY])~ THEN BNEERA NeJa2Chain ~Jaheira, why did you become an adventurer?~ DO ~SetGlobal("AY#NEJA2","LOCALS",1)~
...
CHAIN IF WEIGHT #-1 ~Global("AY#NEKH1","LOCALS",0) InParty("khalid") See("khalid") !StateCheck(Myself,CD_STATE_NOTVALID) !StateCheck("khalid",CD_STATE_NOTVALID) CombatCounter(0) !See([ENEMY]) !AreaType(CITY)~ THEN BNEERA NeKh1Chain ~Ow!  By the nine hells, another rock!  I think I have a hole in my boot.~ DO ~SetGlobal("AY#NEKH1","LOCALS",1)~
...
CHAIN IF WEIGHT #-1 ~Global("AY#NEMO1","LOCALS",0) InParty("montaron") See("montaron") !StateCheck(Myself,CD_STATE_NOTVALID) !StateCheck("montaron",CD_STATE_NOTVALID) CombatCounter(0) !See([ENEMY])~ THEN BNEERA NeMo1Chain ~What was that look for, Monty?~ DO ~SetGlobal("AY#NEMO1","LOCALS",1)~
...
CHAIN IF WEIGHT #-1 ~Global("AY#NEXA2","LOCALS",0) InParty("xan") See("xan") !StateCheck(Myself,CD_STATE_NOTVALID) !StateCheck("xan",CD_STATE_NOTVALID) CombatCounter(0) !See([ENEMY])~ THEN BNEERA NeXa2Chain ~Where did you learn magic, Xan?~ DO ~SetGlobal("AY#NEXA2","LOCALS",1)~
...
CHAIN IF WEIGHT #-1 ~Global("AY#NEXZ1","LOCALS",0) InParty("neera") See("neera") !StateCheck(Myself,CD_STATE_NOTVALID) !StateCheck("neera",CD_STATE_NOTVALID) CombatCounter(0) !See([ENEMY])~ THEN BXZAR NeXz1Chain ~I must say that I am intrigued by your wild magic, Neera.~ DO ~SetGlobal("AY#NEXZ1","LOCALS",1)~
